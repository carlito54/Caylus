    ...
    class BoutonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            if (Integer.parseInt(jt.getText()) > 1 && Integer.parseInt(jt.getText()) < 6) {
                imp = new ImagePanel("Images/3070_1.jpg");
                imp.setLayout(null);
                jf.remove(jp);
                jf.setSize(650, 766);
                jtab = new HashMap<>();
                ...
                for (int i = 14; i < 36; i++) {
                    ImagePanel imp1 = new ImagePanel("Images/ini.png");
                    imp1.setLayout(null);
                    imp1.setBounds(jeu.getCoord()[i].getX(), jeu.getCoord()[i].getY(), 15, 15);
                    jtab.put(((i - 4) * 5 + 2), imp1);

                    ImagePanel imp2 = new ImagePanel("Images/ini.png");
                ...
                ImagePanel imptest = new ImagePanel("Images/prevot.jpg");
        ...
        public void initialisationPlateau(ArrayList<Integer> choixBatNeutre, int pos, int emplacement) {
            Coordonnee[] coord = jeu.getCoord();
            ImagePanel jp8 = new ImagePanel(neutre[choixBatNeutre.get(emplacement)]);
            jp8.setPreferredSize(new Dimension(60, 50));
            jp8.setImage(neutre[choixBatNeutre.get(emplacement)]);
            jp8.setLayout(null);
        ...
        public void placerOuvrier(int pos) {
            ...
            if (jeu.isaDroit()) {
                ...
                if (j.getNom() == "Joueur1") {
                    jtab.get(((pos - 4) * 5) + 3).setImage("Images/ouvrierrouge.jpg");
                } else {
                    if (j.getNom() == "Joueur2") {
                        jtab.get(((pos - 4) * 5) + 3).setImage("Images/ouvrierbleu.jpg");
                    } else {
                        if (j.getNom() == "Joueur3") {
                            jtab.get(((pos - 4) * 5) + 3).setImage("Images/ouvrierorange.jpg");
                        } else {
                            if (j.getNom() == "Joueur4") {
                                jtab.get(((pos - 4) * 5) + 3).setImage("Images/ouvriervert.jpg");
                            } else {
                                jtab.get(((pos - 4) * 5) + 3).setImage("Images/ouvriernoir.jpg");
                            }
                        }
                    }
                }
